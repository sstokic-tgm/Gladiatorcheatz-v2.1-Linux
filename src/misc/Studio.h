...
public:
	...
	int32_t flags;                  //0x0098
	int32_t numbones;               //0x009C
	int32_t boneindex;              //0x00A0
	int32_t numbonecontrollers;     //0x00A4
	int32_t bonecontrollerindex;    //0x00A8
	int32_t numhitboxsets;          //0x00AC
	int32_t hitboxsetindex;         //0x00B0
	int32_t numlocalanim;           //0x00B4
	int32_t localanimindex;         //0x00B8
	int32_t numlocalseq;            //0x00BC
	int32_t localseqindex;          //0x00C0
	int32_t activitylistversion;    //0x00C4
	int32_t eventsindexed;          //0x00C8
	int32_t numtextures;            //0x00CC
	int32_t textureindex;           //0x00D0
