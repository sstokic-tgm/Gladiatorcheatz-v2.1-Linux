...
public:
	...
	{
		typedef void(* OriginalFn)(void*, bool);
		return vfunc<OriginalFn>(this, 11)(this, bEnable);
	}

	void ResetInputState()
	{
		typedef void(* OriginalFn)(void*);
		return vfunc<OriginalFn>(this, 39)(this);
	}

	bool IsButtonDown(ButtonCode_t code)
	{
		typedef bool(* OriginalFn)(void*, ButtonCode_t);
		return vfunc<OriginalFn>(this, 15)(this, code);
	}

	void GetCursorPosition(int* m_pX, int* m_pY)
	{
		typedef void(* OriginalFn)(void*, int*, int*);
		return vfunc<OriginalFn>(this, 56)(this, m_pX, m_pY);
	}

	const char* ButtonCodeToString(ButtonCode_t ButtonCode)
	{
		typedef const char*(* OriginalFn)(void*, ButtonCode_t);
		return vfunc<OriginalFn>(this, 40)(this, ButtonCode);
	}

	ButtonCode_t VirtualKeyToButtonCode(int nVirtualKey)
	{
		typedef ButtonCode_t(* OriginalFn)(void*, int);
		return vfunc<OriginalFn>(this, 44)(this, nVirtualKey);
	}

	int ButtonCodeToVirtualKey(ButtonCode_t code)
	{
		typedef int(* OriginalFn)(void*, ButtonCode_t);
		return vfunc<OriginalFn>(this, 45)(this, code);
	}
};
