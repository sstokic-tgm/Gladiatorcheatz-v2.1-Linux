...
public:
    ...
    {
        typedef void(* oSetupMove)(void*, C_BasePlayer*, CUserCmd*, IMoveHelper*, void*);
    ...
    {
        typedef void(* oFinishMove)(void*, C_BasePlayer*, CUserCmd*, void*);
